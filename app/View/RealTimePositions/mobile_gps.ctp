<div class="row">
    ...
    <script type="text/javascript">
        ...
        function getLocation()
        {
            ...
            {
                watchID = navigator.geolocation.watchPosition(showPosition, errorHandling, {enableHighAccuracy: true, maximumAge: 25000});
            }
            else
            {
        ...
        function showPosition(position)
        {
            ...
            warning.innerHTML = "纬度: " + position.coords.latitude + "<br>经度: " + position.coords.longitude +
                "<br>方向: " + position.coords.heading + "<br>速度: " + position.coords.speed + "<br>时间: " + d.toLocaleTimeString();
            
            if (Math.abs(position.coords.latitude - lastUploadLat) + Math.abs(position.coords.longitude - lastUploadLon) > 0.0005)
            {
                lastUploadLat = position.coords.latitude;
                lastUploadLon = position.coords.longitude;
